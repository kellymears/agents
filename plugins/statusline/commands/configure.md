---
description: Configure statusline display options (layout, presets, display elements)
allowed-tools: Read, Write, AskUserQuestion
---

# Configure Statusline

**FIRST**: Use the Read tool to load `~/.claude/plugins/statusline/config.json` if it exists.
...
Write to `~/.claude/plugins/statusline/config.json`.
