...
Numerical confidence scores (e.g., "72% confident") imply a precision that doesn't exist. Claude can't meaningfully distinguish between 70% and 75% confidence on a subjective assessment. Narrative descriptions with cited evidence give the user the *reasoning* behind the assessment, letting them calibrate trust themselves.
